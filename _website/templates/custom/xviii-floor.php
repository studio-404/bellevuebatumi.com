	 	...
	 	<div class="ApartmentInsideDiv">
 			<div class="MapAreaImage" id="MapAreaImageID">
	 			...
	 			<map name="features">
				    ...
				    <area shape="poly" coords="124, 244, 124, 270, 400, 320, 400, 297" flor="#flor_18" stage="#Stage_18" href="<?php echo href('55'); ?>" data-maphilight='{"alwaysOn":true}' class="masterTooltip"/>
		 	...
		 	<div class="FloorImages FloorImagesMobile">
		 		<div class="FloorMapArea" id="FloorMapArea">
					...
					<div class="ApartView">
		 			...
		 			<img src="_website/floor/18.png" class="Background MapInside" usemap="#FloorMapAreaName" alt="<?php echo $title; ?>"/>
