...
<div class="FloorPageDiv wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
	 <div class="FloorInfo">
	 	<div class="ApartmentInsideDiv">
 			<div class="MapAreaImage" id="MapAreaImageID">
	 			...
	 			<map name="features">
				    ...
				    <area shape="poly" coords="125, 456, 125, 482, 401, 512, 401, 489" flor="#flor_10" stage="#Stage_10" href="<?php echo href('63'); ?>" data-maphilight='{"alwaysOn":true}' class="masterTooltip"/> 
	 	...
	 	<div class="FloorRightInfo Height100">
	 		...
	 		<div class="LeftInfo"> 
		 		<div class="FloorInfoList FloorInfoListFor10" id="FloorInfoList">
					<?php
		 	...
		 	<div class="FloorImages FloorImagesMobile">
		 		<div class="FloorMapArea" id="FloorMapArea">
					...
					<div class="ApartView">
		 			...
		 			<img src="_website/floor/10.png" class="Background MapInside" usemap="#FloorMapAreaName" alt="<?php echo $title; ?>"/>
