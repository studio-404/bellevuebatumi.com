 			...
 			<div class="MapAreaImage" id="MapAreaImageID">
	 			...
	 			<map name="features">
				    ...
				    <area shape="poly" coords="124, 349, 124, 376, 400, 415, 400, 391" flor="#flor_14" stage="#Stage_14" href="<?php echo href('59'); ?>"/>
				 	<area shape="poly" coords="124, 376, 124, 402, 400, 440, 400, 415" flor="#flor_13" stage="#Stage_13" href="<?php echo href('60'); ?>" data-maphilight='{"alwaysOn":true}' class="masterTooltip"/>
		 	...
		 	<div class="FloorImages FloorImagesMobile">
		 		<div class="FloorMapArea" id="FloorMapArea">
					...
					<div class="ApartView">
		 			...
		 			<img src="_website/floor/13.png" class="Background MapInside" usemap="#FloorMapAreaName" alt="<?php echo $title; ?>"/>
