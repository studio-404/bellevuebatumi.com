	 	...
	 	<div class="ApartmentInsideDiv">
 			<div class="MapAreaImage" id="MapAreaImageID">
	 			...
	 			<map name="features">
				    ...
				    <area shape="poly" coords="125, 509, 125, 536, 401, 560, 401, 536" flor="#flor_8" stage="#Stage_8" href="<?php echo href('65'); ?>" data-maphilight='{"alwaysOn":true}' class="masterTooltip"/>
		 	...
		 	<div class="FloorImages FloorImagesMobile">
		 		<div class="FloorMapArea" id="FloorMapArea">
					...
					<div class="ApartView">
		 			...
		 			<img src="_website/floor/8.png" class="Background MapInside" usemap="#FloorMapAreaName" alt="<?php echo $title; ?>"/>
		 			<map name="FloorMapAreaName" class="FloorMapAreaNameClass">
						<?php
                            foreach ($items as $item):
                                $link = href($id,array(), l(), $item['id']);
                        ?>
