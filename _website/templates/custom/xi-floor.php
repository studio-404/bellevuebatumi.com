	 	...
	 	<div class="ApartmentInsideDiv">
 			<div class="MapAreaImage" id="MapAreaImageID">
	 			...
	 			<map name="features">
				    ...
				    <area shape="poly" coords="125, 429, 125, 456, 401, 489, 401, 465" flor="#flor_11" stage="#Stage_11" href="<?php echo href('62'); ?>" data-maphilight='{"alwaysOn":true}' class="masterTooltip"/>
		 	...
		 	<div class="FloorImages FloorImagesMobile">
		 		<div class="FloorMapArea" id="FloorMapArea">
					...
					<div class="ApartView">
		 			...
		 			<img src="_website/floor/11.png" class="Background MapInside" usemap="#FloorMapAreaName" alt="<?php echo $title; ?>"/>
