...
<div class="FloorPageDiv wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
	 	...
	 	<div class="ApartmentInsideDiv">
 			<div class="MapAreaImage" id="MapAreaImageID">
	 			...
	 			<map name="features">
				    ...
				    <area shape="poly" coords="124, 215, 400, 275, 400, 291, 400, 297, 124, 244" flor="#flor_19" stage="#Stage_19" href="<?php echo href('54'); ?>" data-maphilight='{"alwaysOn":true}' class="masterTooltip"/>
		 	...
		 	<div class="FloorImages FloorImagesMobile">
		 		<div class="FloorMapArea" id="FloorMapArea">
					...
					<div class="ApartView">
		 			...
		 			<img src="_website/floor/19.png" class="Background MapInside" usemap="#FloorMapAreaName" alt="<?php echo $title; ?>"/>
	...
	<div class="StageRightDiv" id="StageRightDivID">
	 	...
	 	<div id="ScrollStage">
			...
			<li id="Stage_16" area="Stage_16"><a href="<?php echo href('55');?>">16 <span><?php echo l('floor'); ?></span></a></li>
			<li id="Stage_15" area="Stage_15"><a href="<?php echo href('57');?>">15 <span><?php echo l('floor'); ?></span></a></li>
