...
<div class="FloorPageDiv wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
	 <div class="FloorInfo">
	 	<div class="ApartmentInsideDiv">
 			<div class="MapAreaImage" id="MapAreaImageID">
	 			...
	 			<map name="features">
				    ...
				    <area shape="poly" coords="126, 669, 126, 695, 402, 709, 402, 683" flor="#flor_2" stage="#Stage_2" href="<?php echo href('71'); ?>" data-maphilight='{"alwaysOn":true}' class="masterTooltip"/>
	 	...
	 	<div class="FloorRightInfo Height100 FloorRightInfo222">
 			<div class="TopTitle">
		 	...
		 	<div class="FloorImages FloorImagesMobile">
				...
				<div class="ApartSoldDiv">
		 		...
		 		<div class="FloorMapArea" id="FloorMapArea">
					<div class="ApartView">
						<div class="Item Item5"><div class="Icon Seaicon"></div><span><?php echo l('sea');?></span></div>
						<div class="Item Item6"><div class="Icon Mountainsicon"></div><span><?php echo l('mountains');?></span></div>
						<div class="Item Item7"><div class="Icon Mountainsicon"></div><span><?php echo l('mountains');?></span></div>
					</div>
		 			<img src="_website/floor/2.png" class="Background MapInside" usemap="#FloorMapAreaName" alt="<?php echo $title; ?>"/>
