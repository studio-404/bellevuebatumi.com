...
<div class="FloorPageDiv wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
	 	...
	 	<div class="ApartmentInsideDiv">
 			<div class="MapAreaImage" id="MapAreaImageID">
	 			...
	 			<map name="features">
				    ...
				    <area shape="poly" coords="124, 270, 124, 296, 400, 345, 400, 320" flor="#flor_17" stage="#Stage_17" href="<?php echo href('56'); ?>" data-maphilight='{"alwaysOn":true}' class="masterTooltip"/>
				    ...
				    <area shape="poly" coords="126, 695, 126, 721, 402, 735, 402, 709" flor="#flor_1" stage="#Stage_1" href="<?php echo href('72'); ?>"/>
		 	...
		 	<div class="FloorImages FloorImagesMobile">
		 		<div class="FloorMapArea" id="FloorMapArea">
					...
					<div class="ApartView">
		 			...
		 			<img src="_website/floor/17.png" class="Background MapInside" usemap="#FloorMapAreaName" alt="<?php echo $title; ?>"/>
	 ...
	 <div class="StageRightDiv" id="StageRightDivID">
	 	...
	 	<div id="ScrollStage">
			...
			<li id="Stage_2" area="Stage_2"><a href="<?php echo href('69');?>">2 <span><?php echo l('floor'); ?></span></a></li>
		</div>
	 </div>
</div>
