	 ...
	 <div class="FloorInfo">
	 	<div class="ApartmentInsideDiv">
 			<div class="MapAreaImage" id="MapAreaImageID">
	 			...
	 			<map name="features">
					<area shape="poly" coords="399, 271, 124, 214, 121, 173, 249, 217, 399, 250" flor="#flor_20" stage="#Stage_20" href="<?php echo href('53'); ?>" data-maphilight='{"alwaysOn":true}' class="masterTooltip"/>
				    ...
				    <area shape="poly" coords="124, 270, 124, 296, 400, 345, 400, 320" flor="#flor_17" stage="#Stage_17" href="javascript:;" />
				    <area shape="poly" coords="124, 296, 124, 323, 400, 368, 400, 345" flor="#flor_16" stage="#Stage_16" href="javascript:;"/>
				    ...
				    <area shape="poly" coords="126, 643, 126, 669, 402, 683, 402, 657" flor="#flor_3" stage="#Stage_3" href="javascript:;"/>
					...
					<div class="FloorInfoWindow"> 
						...
						<div class="hidden AllFlor" id="flor_2">
							<div class="InfoWindow"><span><?php echo menu_title('71'); ?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div>--></div>
						</div>            
						<div class="hidden AllFlor" id="flor_1"> 
							<div class="InfoWindow"><span><?php echo menu_title('72'); ?> <?php echo l('floor'); ?></span><!--<br/><div>available 3 flats</div><label>from <i>$850</i></label>--></div>
						</div>                   
					</div>
				</map>
	 		</div>
	 	...
	 	<div class="FloorRightInfo Height100">
	 		...
	 		<div class="LeftInfo"> 
		 		<div class="FloorInfoList six" id="FloorInfoList">
					<?php
		 	...
		 	<div class="FloorImages FloorImagesMobile">
		 		<div class="FloorMapArea" id="FloorMapArea">
					...
					<div class="ApartView">
		 			...
		 			<img src="_website/floor/20.png" class="Background MapInside" usemap="#FloorMapAreaName" alt="<?php echo $title; ?>"/>
