...
<div class="ApartmentsPageDiv wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
	 <div class="ApartmentsInfo Height100">
	 	<div class="ApartmentBackground">
			<ul id="InsideMenu"><a href="#ScrollStage"></a></ul> 
	 		<div class="MapAreaImage" id="MapAreaImageID">
	 			<img src="_website/img/hd_1_1.png" class="Background map" usemap="#features"/>
	 			<map name="features">
				    ...
				    <area shape="poly" coords="125, 536, 125, 563, 401, 584, 401, 560" flor="#flor_7" stage="#Stage_7" href="<?php echo href('66');?>" data-maphilight='{"alwaysOn":true}' class="masterTooltip"/>
				    <area shape="poly" coords="126, 563, 126, 590, 402, 609, 402, 584" flor="#flor_6" stage="#Stage_6" href="<?php echo href('67');?>"/>
					...
					<div class="FloorInfoWindow"> 
						...
						<div class="hidden AllFlor" id="flor_19">
							<div class="InfoWindow"><span><?php echo menu_title('54');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div>
						<div class="hidden AllFlor" id="flor_18">
							<div class="InfoWindow"><span><?php echo menu_title('55');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div>
						...
						<div class="hidden AllFlor" id="flor_15">
							<div class="InfoWindow"><span><?php echo menu_title('58');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div>
						<div class="hidden AllFlor" id="flor_14">
							<div class="InfoWindow"><span><?php echo menu_title('59');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div>
						<div class="hidden AllFlor" id="flor_13">
							<div class="InfoWindow"><span><?php echo menu_title('60');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div>
						<div class="hidden AllFlor" id="flor_12">
							<div class="InfoWindow"><span><?php echo menu_title('61');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div>
						<div class="hidden AllFlor" id="flor_11">
							<div class="InfoWindow"><span><?php echo menu_title('62');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div>
						<div class="hidden AllFlor" id="flor_10">
							<div class="InfoWindow"><span><?php echo menu_title('63');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div> 
						<div class="hidden AllFlor" id="flor_9">
							<div class="InfoWindow"><span><?php echo menu_title('64');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div>
						<div class="hidden AllFlor" id="flor_8">
							<div class="InfoWindow"><span><?php echo menu_title('65');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div>
						<div class="AllFlor" id="flor_7">
							<div class="InfoWindow"><span><?php echo menu_title('66');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div>            
						<div class="hidden AllFlor" id="flor_6">
							<div class="InfoWindow"><span><?php echo menu_title('67');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div>            
						<div class="hidden AllFlor" id="flor_5">
							<div class="InfoWindow"><span><?php echo menu_title('68');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div>            
						<div class="hidden AllFlor" id="flor_4">
							<div class="InfoWindow"><span><?php echo menu_title('69');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div>            
						...
						<div class="hidden AllFlor" id="flor_2">
							<div class="InfoWindow"><span><?php echo menu_title('71');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div>            
						<div class="hidden AllFlor" id="flor_1"> 
							<div class="InfoWindow"><span><?php echo menu_title('72');?> <?php echo l('floor'); ?></span><!--<br/><div><?php echo l('available'); ?></div><label>&nbsp;</label>--></div>
						</div>                   
					</div>
	 	...
	 	<div class="ApartmentBottomList" style="display:none;">
	 		<div class="col-sm-3"><div class="Item Item_1">ზღვასთან ახლოს <br/>and the mountains</div></div>
	 		<div class="col-sm-3"><div class="Item Item_2">Convenient <br/>location</div></div>
	 		<div class="col-sm-3"><div class="Item Item_3">Mild <br/>climate</div></div>
	 		<div class="col-sm-3"><div class="Item Item_4">Around the <br/>clock service</div></div>
	 	</div>
	 </div>
